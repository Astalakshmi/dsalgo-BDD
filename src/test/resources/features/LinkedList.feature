...
Feature: DS Portal Linked List Page Functionality
  ...
  Scenario: Validate the Try editor for positive input from Introduction page
  ...
  Scenario: validate the Try editor for positive input from Creating Linked list page
  ...
  Scenario: validate the Try editor for positive input from Types of Linked List page
  ...
  Scenario: validate the Try editor for positive input from Implement linked list in python page
  ...
  Scenario: validate the Try editor for positive input from Traversal page
  ...
  Scenario: validate the Try editor for positive input from Insertion page
  ...
  Scenario: validate the Try editor for positive input from Deletion page
