...
@CucumberOptions(features = { "@target/rerun.txt" }, glue = { "stepdefinitions", "hooks" }, monochrome = true,
		// tags= "@Login or @RegisterInvalidCredentials or @Queue or @Graph or @Stack or
		// @LinkedList or @Tree or @DataStructure or @Home" ,
